package com.song.video_pay.config;
...
public class WeChatConfig {
     ...
     * 开放平台用户信息获取地址
     */
    private final static String OPEN_ACCESS_USER_URL = "https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s";

    public static String getOpenAccessUserUrl() {
        return OPEN_ACCESS_USER_URL;
    }
